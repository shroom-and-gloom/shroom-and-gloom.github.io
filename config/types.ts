...
export type FactsStatus = "skeleton" | "verified" | "mixed" | "player-reported";

export type PageSourceType = "official" | "steam-data" | "player-reported";

export interface PageSource {
  label: string;
  url: string;
  type: PageSourceType;
  /** Human-readable source class shown in the Sources module. */
  typeLabel: string;
  reviewed: string;
  note?: string;
}
...
export interface SeoPageDefinition {
  ...
  /** Short player-facing trust line shown near the hero. */
  factsLabel?: string;
  sources?: PageSource[];
  hero: {
    eyebrow?: string;
